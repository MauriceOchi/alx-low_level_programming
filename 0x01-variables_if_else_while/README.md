...
File -print_alphabet.c is a C program that prints the alphabet in lowercase, followed by a new line.
...
File 10-print_comb.c is a C program that prints the numbers from 00 to 99.
